...
FWidget::EWidgetMode FDragonControlBaseEditMode::GetWidgetMode() const
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
...
FWidget::EWidgetMode FDragonControlBaseEditMode::ChangeToNextWidgetMode(FWidget::EWidgetMode CurWidgetMode)
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
...
bool FDragonControlBaseEditMode::SetWidgetMode(FWidget::EWidgetMode InWidgetMode)
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
